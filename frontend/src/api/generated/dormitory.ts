 ...
 *
 * Up to three photographs. The ceiling is one constant
 * (`MaintenanceRequest::MAX_PHOTOS`), read both by this route's validation,
 * which answers 422 naming `photos`, and by the CHECK constraint that
 * states the same figure in the database.
 *
