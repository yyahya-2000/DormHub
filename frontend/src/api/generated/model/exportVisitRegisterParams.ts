 ...
 */
import type { ExportVisitRegisterFormat } from './exportVisitRegisterFormat';

export type ExportVisitRegisterParams = {
/**
...
until?: string;
/**
 * `json` for the register as data, `csv` for the file. §3.9.6 also asks for PDF; this iteration produces the two above.
 */
format?: ExportVisitRegisterFormat;
/**
 * @minimum 1
 */
page?: number;
