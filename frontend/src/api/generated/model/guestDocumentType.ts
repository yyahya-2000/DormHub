...
/**
 * `foreign_passport` and `residence_permit` mark the guest as a foreign national and raise FR-23's warning. Both, because a residence permit is issued to a foreign national as well and the warning is about the procedure rather than about the booklet.
 */
export type GuestDocumentType = typeof GuestDocumentType[keyof typeof GuestDocumentType];
