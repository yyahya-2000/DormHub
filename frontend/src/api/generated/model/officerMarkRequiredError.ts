...
import type { OfficerMarkRequiredErrorRequiredField } from './officerMarkRequiredErrorRequiredField';

/**
 * FR-23, second criterion.
 */
export interface OfficerMarkRequiredError {
  message: string;
  guest_request_id?: number;
  guest_doc_type?: GuestDocumentType;
  required_field?: OfficerMarkRequiredErrorRequiredField;
}
