...
export interface AnnouncementInput {
  /**
     * The dormitory addressed. Omit it, or send null, to address every dormitory — the administrator's right and nobody else's.
     * @nullable
     */
  ...
  /** Whether the reader is required to acknowledge the notice (FR-12). A mandatory announcement is also delivered as a notification the resident cannot switch off. */
