...
import type { ResidentCardOpenObligationsItemKind } from './residentCardOpenObligationsItemKind';

export type ResidentCardOpenObligationsItem = {
  kind: ResidentCardOpenObligationsItemKind;
  residency_id: number;
