...
import type { ShowMaintenanceQueueFormat } from './showMaintenanceQueueFormat';

export type ShowMaintenanceQueueParams = {
/**
 * Omit for the open requests; name one to see that state alone.
 */
status?: MaintenanceRequestStatus;
category?: MaintenanceCategory;
/**
 * «At least this old», in days since submission — the question a warden asks, «what has been sitting here more than a week».
 * @minimum 0
 * @maximum 3650
 */
min_age_days?: number;
/**
 * Only the requests past their planned date or past the configured threshold.
 */
overdue?: boolean;
/**
 * Start of the period, measured on the submission. Omit for the whole queue.
 */
from?: string;
until?: string;
format?: ShowMaintenanceQueueFormat;
/**
 * @minimum 1
 */
page?: number;
