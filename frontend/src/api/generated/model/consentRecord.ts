...
export interface ConsentRecord {
  id: number;
  /**
     * The account whose consent this is. Null for a guest's, which names the request instead: exactly one of the two is ever set, and the database refuses any other shape.
     * @nullable
     */
  user_id?: number | null;
  /**
     * The guest request this consent was taken against, at the post.
     * @nullable
     */
  guest_request_id?: number | null;
  ...
  accepted_at: string;
  /**
     * When the consent was withdrawn, or superseded by a consent to a newer wording. The row is never deleted and never rewritten: the history is the evidence.
     * @nullable
     */
  revoked_at: string | null;
  /** Whether this consent stands today. */
  in_force: boolean;
  /**
     * @maxLength 45
     * @nullable
