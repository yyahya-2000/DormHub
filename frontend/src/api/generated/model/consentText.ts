...
export interface ConsentText {
  ...
  /**
     * The identifier of the wording. It names a file under version control, which is what makes a record demonstrable afterwards: art. 9 part 3 of Federal Law No. 152-FZ puts the burden of proving consent on the operator, and a revision whose text could not be produced would prove nothing.
     * @maxLength 32
     */
  revision: string;
  title: string;
  /** The wording itself, in Markdown. Shown to the person before they decide. */
  body: string;
}
