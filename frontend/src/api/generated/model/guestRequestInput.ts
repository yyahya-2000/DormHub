...
export interface GuestRequestInput {
  ...
  /**
     * Stored encrypted and never returned. Deliberately shapeless: §2.7.1's minimisation means the type and the number and no scan of the page, and the formats of five kinds of document across as many countries are not something a dormitory's validator should claim to know.
     * @minLength 4
     * @maxLength 64
     */
  guest_doc_number: string;
  visit_date: string;
