...
/**
 * One row of the journal of clause 2.1.2, plus the operator.
 */
export interface VisitRegisterEntry {
  guest_visit_id?: number;
  guest_full_name?: string;
  /** The type and the masked number, as one column. */
  ...
  /** The officer who recorded the entry, and the one who recorded the exit when it was a different shift. */
  operator?: string;
