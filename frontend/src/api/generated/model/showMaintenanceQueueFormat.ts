...
export type ShowMaintenanceQueueFormat = typeof ShowMaintenanceQueueFormat[keyof typeof ShowMaintenanceQueueFormat];


export const ShowMaintenanceQueueFormat = {
  json: 'json',
  csv: 'csv',
} as const;
