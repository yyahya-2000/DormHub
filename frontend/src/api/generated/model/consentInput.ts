...
export interface ConsentInput {
  ...
  /**
     * The revision the person was shown, as it came from `GET /consents/pending`. Sending it back is what makes the record name the text they actually read; a revision that is not the one in force is refused with 422.
     * @maxLength 32
     */
  revision: string;
}
