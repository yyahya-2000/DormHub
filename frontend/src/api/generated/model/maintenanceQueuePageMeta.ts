 ...
 */
import type { MaintenanceQueuePageMetaColumns } from './maintenanceQueuePageMetaColumns';
...
export type MaintenanceQueuePageMeta = {
  ...
  per_page?: number;
  total?: number;
  /** The configured threshold this page's `overdue` column was measured against (FR-40, second criterion). */
  overdue_after_days?: number;
  /** The column keys and their headings, in the order the CSV writes them. */
  columns?: MaintenanceQueuePageMetaColumns;
};
